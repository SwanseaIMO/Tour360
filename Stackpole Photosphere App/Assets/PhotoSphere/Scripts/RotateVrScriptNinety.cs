...
namespace VRStandardAssets.Examples
{
    ...
    public class RotateVrScriptNinety : MonoBehaviour
    {
		...
		[SerializeField] private Renderer m_Renderer_3;
		[SerializeField] private Renderer m_Renderer_4;
        ...
        private void Awake ()
        {
			...
			m_Renderer_3.material = m_NormalMaterial;
			m_Renderer_4.material = m_NormalMaterial;
            Debug.Log(rotate);
        }
        ...
        private void HandleOver()
        {
			...
			m_Renderer_3.material = m_OverMaterial;
			m_Renderer_4.material = m_OverMaterial;
        }
        ...
        private void HandleClick()
        {
			...
			m_Renderer_3.material = m_ClickedMaterial;
			m_Renderer_4.material = m_ClickedMaterial;
        ...
        private void HandleDoubleClick()
        {
			...
			m_Renderer_3.material = m_DoubleClickedMaterial;
			m_Renderer_4.material = m_DoubleClickedMaterial;
            /// move camera to new position ; 
            Debug.Log(rotate);
            dolly.transform.eulerAngles = dolly.transform.eulerAngles + new Vector3(0, rotate, 0);
			Compass.transform.eulerAngles = Compass.transform.eulerAngles + new Vector3(0, -rotate, 0);
